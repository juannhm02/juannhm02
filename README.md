...
Welcome to my GitHub profile. I'm a Computer Engineering graduate from the University of Córdoba, now starting a Master's in Cybersecurity Management, Ethical Hacking & Offensive Security. I have hands-on experience as a Frontend Developer (React/JavaScript) at Genially, and I build full-stack and mobile projects across React, Node.js, and Python. Here you'll find a mix of personal, academic and professional projects that reflect my journey in software development.

## 🌍 About me

- 🎓 Computer Engineering graduate, University of Córdoba (2020 – 2026).
- 🔐 Currently pursuing an MSc in Cybersecurity Management, Ethical Hacking & Offensive Security.
...
🔗 [Repo](https://github.com/juannhm02/totustuus-web)

**Aquashift** — React Native · Expo · TypeScript · Firestore
...
🔗 [Repo](https://github.com/juannhm02/aquashift)

**APP-ISM** — React Native · TypeScript · Node.js
Mobile application for management workflows, with authentication, barcode scanning, and user flows.
🔗 [Repo](https://github.com/juannhm02/APP-ISMFront)

**UcoLib** — NestJS · TypeScript · Docker
Modular backend designed for scalable services and Docker-based deployment.
🔗 [Repo](https://github.com/juannhm02/UcoLib)

**Countrle** — Django · React · MongoDB
Wordle-inspired web game combining Django and React for an interactive experience around countries and general knowledge.
🔗 [Live demo](https://countrle.netlify.app) · [Repo](https://github.com/juannhm02/Countrle)

**Reserva de Pistas** — Java · JavaScript · CSS
...
🔗 [Repo](https://github.com/juannhm02/ReservaPistas)

**Mailing Actividades Extracurriculares** — C++
Mailing management tool built to coordinate communications for extracurricular and student-representation activities.
🔗 [Repo](https://github.com/juannhm02/MailingActividadesExtracurriculares)

**Gestor de Máquinas** — C++
Cluster reservation system built for a university systems course.
🔗 [Repo](https://github.com/juannhm02/Gestor-de-maquinas)
...
[![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=juannhm02&theme=dark)](https://github.com/juannhm02)
